...
public class UserController 
{
	 ...
	 * @return
	 * 
	 * It is assumed that Booking is initiated and primary Booking record is inserted
	 * in DB, the corresponding  book_id will be sent as a part of RequestBody of this API
	 */
	@PostMapping("/payment")
